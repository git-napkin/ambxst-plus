...
Item {
    ...
    property bool isEditingAmbxstPlus: false
    ...
    function getAmbxstPlusBinds() {
        ...
        if (ambxstPlus.system) {
            ...
            for (const key of systemKeys) {
                if (ambxstPlus.system[key]) {
                    binds.push({
                        category: "System",
                        name: key.charAt(0).toUpperCase() + key.slice(1),
                        path: "ambxst+.system." + key,
                        bind: ambxstPlus.system[key]
                    });
                }
            }
        }
    ...
    Flickable {
        ...
        ColumnLayout {
            ...
            // ambxst+ binds view
            Repeater {
                id: ambxstPlusRepeater
                model: root.currentCategory === "ambxst+" ? root.getAmbxstPlusBinds() : []
            ...
            Text {
                ...
                Layout.topMargin: 20
                visible: (root.currentCategory === "ambxst+" && ambxstPlusRepeater.count === 0) || (root.currentCategory === "custom" && customRepeater.count === 0)
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    RowLayout {
                        ...
                        StyledRect {
                            id: deleteButton
                            visible: !root.isEditingAmbxstPlus && !root.isCreatingNew
                        ...
                        StyledRect {
                            id: resetButton
                            visible: root.isEditingAmbxstPlus
                ...
                Item {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            visible: root.isEditingAmbxstPlus && root.editingBind !== null
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                StyledRect {
                                    id: removeKeyBtn
                                    visible: root.editKeys.length > 1 && !root.isEditingAmbxstPlus
                        ...
                        ColumnLayout {
                            Layout.fillWidth: true
                            spacing: 8
                            // visible: !root.isEditingAmbxstPlus - Removed to allow editing flags for ambxst+ binds
                            ...
                            RowLayout {
                                ...
                                // Page indicator
                                Text {
                                    visible: root.editActions.length > 1 && !root.isEditingAmbxstPlus
    ...
    component BindItem: StyledRect {
        ...
        property bool isAmbxstPlus: true
        property bool isHovered: false
