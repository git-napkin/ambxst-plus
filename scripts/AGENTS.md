...
| `ai/computer_use/` | Python | `use_computer` | Coords, screenshot downscale, input, AT-SPI, window targeting, live Hyprland focus verify, pointer-lock session rules, doctor |
